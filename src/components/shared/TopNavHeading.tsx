...
const TopNavHeading = ({ className }: { className?: string }) => {
  ...
  return (
    <RevealAnimation delay={0.1} direction="up" instant>
      <div className={cn('bg-[#D63848] absolute top-0 left-0 z-50 w-full px-5 py-1.5 text-white', className)}>
        <div className="relative mx-auto px-5 md:mr-10 md:px-5">
          <div className="from-[#D63848] dark:from-background-5 absolute top-0 left-0 z-10 h-full w-[15%] bg-linear-to-r to-transparent md:w-[20%]" />
          <div className="from-[#D63848] dark:from-background-5 absolute top-0 right-0 z-10 h-full w-[15%] bg-linear-to-l to-transparent md:w-[20%]" />
          <div className="flex items-center justify-center">
            <Marquee autoFill speed={40}>
              <p className="text-tagline-2 font-inter-tight mr-2 leading-[150%] font-normal text-white">
              ...
              <p className="text-tagline-2 font-inter-tight leading-[150%] font-normal text-white">
